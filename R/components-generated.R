...
calcite_accordion <- function(...) {
  ...
  res <- htmltools::tag("calcite-accordion", dots)
...
calcite_accordion_item <- function(...) {
  ...
  res <- htmltools::tag("calcite-accordion-item", dots)
...
#'  |appearance       |appearance    |Specifies the appearance of the component.                                                                                                               |"solid" &#124; "transparent"            |TRUE                  |
#'  |aria             |NA            |Use this property to override or extend ARIA properties and attributes on the component's button.                                                        |Check API reference                     |FALSE                 |
...
#'  |textEnabled      |text-enabled  |When `true`, indicates whether the text is displayed.                                                                                                    |boolean                                 |TRUE                  |
...
calcite_action <- function(...) {
  ...
  res <- htmltools::tag("calcite-action", dots)
...
calcite_action_group <- function(...) {
  ...
  res <- htmltools::tag("calcite-action-group", dots)
...
calcite_alert <- function(...) {
  ...
  res <- htmltools::tag("calcite-alert", dots)
...
calcite_block <- function(...) {
  ...
  res <- htmltools::tag("calcite-block", dots)
...
calcite_date_picker <- function(...) {
  ...
  res <- htmltools::tag("calcite-date-picker", dots)
...
calcite_input_message <- function(...) {
  ...
  res <- htmltools::tag("calcite-input-message", dots)
...
#'  |Name              |Attribute          |Description                                                                                                                                              |Values                                       |Reflects to Attribute |
#'  |:-----------------|:------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------|:---------------------|
#'  |alignment         |alignment          |Specifies the text alignment of the component's value.                                                                                                   |"center" &#124; "end" &#124; "start"         |TRUE                  |
#'  |autocomplete      |NA                 |Specifies the type of content to autocomplete, for use in forms. Read the native attribute's documentation on MDN for more info.                         |AutoFill                                     |FALSE                 |
...
calcite_input_number <- function(...) {
  ...
  res <- htmltools::tag("calcite-input-number", dots)
...
#'  |iconFlipRtl       |icon-flip-rtl      |When `true`, the icon will be flipped when the element direction is right-to-left (`"rtl"`).                                                                                                            |boolean                                |TRUE                  |
#'  |label             |label              |Accessible name for the component's button or hyperlink.                                                                                                                                                |string                                 |FALSE                 |
#'  |labelText         |label-text         |                                                                                                                                                                                                        |string                                 |FALSE                 |
#'  |loading           |loading            |When `true`, the component is in the loading state and `calcite-progress` is displayed.                                                                                                                 |boolean                                |TRUE                  |
#'  |maxLength         |max-length         |When the component resides in a form, specifies the maximum length of text for the component's value.                                                                                                   |number                                 |TRUE                  |
#'  |messageOverrides  |NA                 |Use this property to override individual strings used by the component.                                                                                                                                 |Check API reference                    |FALSE                 |
#'  |minLength         |min-length         |When the component resides in a form, specifies the minimum length of text for the component's value.                                                                                                   |number                                 |TRUE                  |
...
calcite_input_text <- function(...) {
  ...
  res <- htmltools::tag("calcite-input-text", dots)
...
#'  |layout    |layout    |Check API reference                                                                                                                           |"block" &#124; "default" &#124; "inline" &#124; "inline-space-between" |TRUE                  |
#'  |scale     |scale     |Specifies the size of the component.                                                                                                          |"l" &#124; "m" &#124; "s"                                              |TRUE                  |
...
calcite_label <- function(...) {
  ...
  res <- htmltools::tag("calcite-label", dots)
...
#' 
#'
#' Any attributes placed on <calcite-link> component will propagate to the rendered child  Passing a 'href' will render an anchor link, instead of a button.  It is the consumers responsibility to add aria information, rel, target, for links, and any link attributes for form submission
#'
#' @details
#' ## Properties
...
calcite_link <- function(...) {
  ...
  res <- htmltools::tag("calcite-link", dots)
...
#'  |Name                |Attribute            |Description                                                                                                                                                                                                                                                                       |Values                                                           |Reflects to Attribute |
#'  |:-------------------|:--------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------|:---------------------|
#'  |canPull             |NA                   |When provided, the method will be called to determine whether the element can move from the list.                                                                                                                                                                                 |(detail: ListDragDetail) => boolean &#124; "clone"               |FALSE                 |
...
#'  |filterProps         |NA                   |Specifies the properties to match against when filtering. If not set, all properties will be matched (`description`, `label`, `metadata`, and the `calcite-list-item-group`'s `heading`).                                                                                         |Check API reference                                              |FALSE                 |
#'  |filterText          |filter-text          |Text for the component's filter input field.                                                                                                                                                                                                                                      |string                                                           |TRUE                  |
...
#'  |selectionMode       |selection-mode       |Specifies the selection mode of the component, where:  `"multiple"` allows any number of selections,  `"single"` allows only one selection,  `"single-persist"` allows one selection and prevents de-selection, and  `"none"` does not allow any selections.                      |"multiple" &#124; "none" &#124; "single" &#124; "single-persist" |TRUE                  |
#'  |sortDisabled        |sort-disabled        |When `true`, and a `group` is defined, `calcite-list-item`s are no longer sortable.                                                                                                                                                                                               |boolean                                                          |TRUE                  |
...
calcite_list <- function(...) {
  ...
  res <- htmltools::tag("calcite-list", dots)
...
calcite_list_item <- function(...) {
  ...
  res <- htmltools::tag("calcite-list-item", dots)
...
calcite_notice <- function(...) {
  ...
  res <- htmltools::tag("calcite-notice", dots)
...
#'  |closed             |closed              |When `true`, the component will be hidden.                                                                                                                                                                                                                                                                                                                                    |boolean                                                                                                                                                                                                                                                                                                                                                                                         |TRUE                  |
#'  |collapsed          |collapsed           |When `true`, hides the component's content area.                                                                                                                                                                                                                                                                                                                              |boolean                                                                                                                                                                                                                                                                                                                                                                                         |TRUE                  |
#'  |collapseDirection  |collapse-direction  |When `collapsible` is present, specifies the direction of the collapse icon.                                                                                                                                                                                                                                                                                                  |"down" &#124; "up"                                                                                                                                                                                                                                                                                                                                                                              |FALSE                 |
#'  |collapsible        |collapsible         |When `true`, the component is collapsible.                                                                                                                                                                                                                                                                                                                                    |boolean                                                                                                                                                                                                                                                                                                                                                                                         |TRUE                  |
#'  |description        |description         |A description for the component.                                                                                                                                                                                                                                                                                                                                              |string                                                                                                                                                                                                                                                                                                                                                                                          |FALSE                 |
#'  |disabled           |disabled            |When `true`, interaction is prevented and the component is displayed with lower opacity.                                                                                                                                                                                                                                                                                      |boolean                                                                                                                                                                                                                                                                                                                                                                                         |TRUE                  |
#'  |heading            |heading             |The component header text.                                                                                                                                                                                                                                                                                                                                                    |string                                                                                                                                                                                                                                                                                                                                                                                          |FALSE                 |
...
calcite_panel <- function(...) {
  ...
  res <- htmltools::tag("calcite-panel", dots)
...
calcite_segmented_control <- function(...) {
  ...
  res <- htmltools::tag("calcite-segmented-control", dots)
...
calcite_shell <- function(...) {
  ...
  res <- htmltools::tag("calcite-shell", dots)
...
#'  |labelFormatter    |NA                 |When specified, allows users to customize handle labels.                                                                                                                     |(value: number, type: "max" &#124; "min" &#124; "value" &#124; "tick", defaultFormatter: (value: number) => string) => string |FALSE                 |
...
#'  |mirrored          |mirrored           |When `true`, the component will display values from high to low.  Note that this value will be ignored if the slider has an associated histogram.                            |boolean                                                                                                                       |TRUE                  |
#'  |name              |name               |Specifies the name of the component.  Required to pass the component's `value` on form submission.                                                                           |string                                                                                                                        |TRUE                  |
#'  |numberingSystem   |numbering-system   |Specifies the Unicode numeral system used by the component for localization.                                                                                                 |"arab" &#124; "arabext" &#124; "latn"                                                                                         |FALSE                 |
...
calcite_slider <- function(...) {
  ...
  res <- htmltools::tag("calcite-slider", dots)
...
#'  |form           |form             |The `id` of the form that will be associated with the component.  When not set, the component will be associated with its ancestor form element, if any. |string                    |TRUE                  |
#'  |label          |label            |Accessible name for the component.                                                                                                                       |string                    |FALSE                 |
#'  |labelTextEnd   |label-text-end   |When provided, displays label text at the end of the component                                                                                           |string                    |FALSE                 |
#'  |labelTextStart |label-text-start |When provided, displays label text at the start of the component                                                                                         |string                    |FALSE                 |
#'  |name           |name             |Specifies the name of the component.  Required to pass the component's `value` on form submission.                                                       |string                    |TRUE                  |
#'  |scale          |scale            |Specifies the size of the component.                                                                                                                     |"l" &#124; "m" &#124; "s" |TRUE                  |
#'  |value          |value            |The component's value.                                                                                                                                   |any                       |FALSE                 |
...
calcite_switch <- function(...) {
  ...
  res <- htmltools::tag("calcite-switch", dots)
...
calcite_tile <- function(...) {
  ...
  res <- htmltools::tag("calcite-tile", dots)
...
calcite_tile_group <- function(...) {
  ...
  res <- htmltools::tag("calcite-tile-group", dots)
